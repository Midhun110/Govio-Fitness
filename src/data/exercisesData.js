...
exports.getLocalEquipmentRequiredTag = exports.getExerciseVideoSource = exports.getExerciseImageSource = exports.getExerciseImageUrl = exports.MOCK_EXERCISES = void 0;
exports.MOCK_EXERCISES = [
    {
        "id": "ex-1",
        "name": "Bench Press",
...
const getExerciseImageUrl = (muscleGroup) => {
...
exports.getExerciseImageUrl = getExerciseImageUrl;
const nameToLocalAsset = {
...
const getExerciseImageSource = (exercise) => {
    ...
    if (!img) {
        return { uri: (0, exports.getExerciseImageUrl)(exercise.muscle_group) };
    }
...
exports.getExerciseImageSource = getExerciseImageSource;
const nameToLocalVideo = {
    // Chest
...
const getExerciseVideoSource = (exercise) => {
    const nameKey = exercise.name.toLowerCase().trim();
...
exports.getExerciseVideoSource = getExerciseVideoSource;
const getLocalEquipmentRequiredTag = (name) => {
    const nameLower = name.toLowerCase().trim();
    const match = exports.MOCK_EXERCISES.find(e => e.name.toLowerCase().trim() === nameLower);
    return match?.equipment_required;
};
exports.getLocalEquipmentRequiredTag = getLocalEquipmentRequiredTag;
